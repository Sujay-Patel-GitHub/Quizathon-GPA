      ...
      <Card className="w-full max-w-4xl border-0 shadow-2xl bg-white/80 backdrop-blur-xl overflow-hidden grid md:grid-cols-2 relative z-10">
        ...
        <div className="p-5 md:p-8 flex flex-col justify-center space-y-4 md:space-y-8">
          ...
          <div className="space-y-6">
            ...
            <Button
              size="lg"
              className="w-full h-10 md:h-14 rounded-xl text-base md:text-lg font-bold shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-300"
              onClick={handleStartQuiz}
              disabled={!subject}
            >
              Start Quiz <Rocket className="ml-2 w-4 h-4 md:w-5 md:h-5 animate-pulse" />
            </Button>
